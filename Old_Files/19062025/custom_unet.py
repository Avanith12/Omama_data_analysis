...
class CustomUNet:
    def __init__(
        ...
        save_model_path="/hpcstor6/scratch01/a/a.kanamarlapudi001/datasets",
        patience=20,
        min_delta=0.001,
    ):
        self.metrics = None
    ...
    def evaluate(self):
        ...
        results = self.model.evaluate(
            test_generator, steps=len(os.listdir(self.test_image_folder)) // self.batch_size
        )
    ...
    def visualize_predictions(self, num_images=10):
        ...
        test_steps = num_images  # or whatever number of steps you want to visualize
...
if __name__ == "__main__":
    ...
    unet = CustomUNet(img_height=512, img_width=512, batch_size=32, save_model_path="/hpcstor6/scratch01/a/a.kanamarlapudi001/datasets/model_weights.weights.h5")
    
    

    # Define paths to your training, validation, and test data
    train_image_folder = (
        "/hpcstor6/scratch01/a/a.kanamarlapudi001/datasets/splits/train/images"
    )
    train_mask_folder = (
        "/hpcstor6/scratch01/a/a.kanamarlapudi001/datasets/splits/train/masks"
    )
    val_image_folder = (
        "/hpcstor6/scratch01/a/a.kanamarlapudi001/datasets/splits/val/images"
    )
    val_mask_folder = (
        "/hpcstor6/scratch01/a/a.kanamarlapudi001/datasets/splits/val/masks"
    )
    test_image_folder = (
        "/hpcstor6/scratch01/a/a.kanamarlapudi001/datasets/splits/test/images"
    )
    test_mask_folder = (
        "/hpcstor6/scratch01/a/a.kanamarlapudi001/datasets/splits/test/masks"
    )
